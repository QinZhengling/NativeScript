...
export class ItemService {
  private items = new Array<Item>(
    {
      ...
      url: "https://c-ssl.duitang.com/uploads/item/202007/28/20200728223611_nbywk.jpg",
    ...
    },
    {
      ...
      url: "https://c-ssl.duitang.com/uploads/blog/202303/10/20230310015104_15b63.jpeg",
    ...
    },
    {
      ...
      url: "https://c-ssl.duitang.com/uploads/blog/202303/17/20230317005620_34a20.jpeg",
  ...
  getFlickById(id: number): Item | undefined {
    return this.items.find((flick) => flick.id === id) || undefined;
  }
}
